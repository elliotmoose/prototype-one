...
public class WeaponData
{
  ...
  public static WeaponData MeleeWeaponData()
  {
    ...
    newWeaponData.AddWeaponPropertyValue("UPGRADE_COST", "Upgrade Cost", new float[] { 0 }, PropertyRepresentationType.RAW);
    newWeaponData.AddWeaponPropertyValue("DAMAGE", "Damage", new float[] { 50 }, PropertyRepresentationType.RAW);
    newWeaponData.AddWeaponPropertyValue("FIRE_RATE", "Fire Rate", new float[] { 1000 }, PropertyRepresentationType.RAW);
    newWeaponData.AddWeaponPropertyValue("RANGE", "Range", new float[] { 4f }, PropertyRepresentationType.RAW);
    newWeaponData.AddWeaponPropertyValue("DNA_WORTH", "Base Cost", new float[] { 0 }, PropertyRepresentationType.RAW);
